          ...
          <div>
            ...
            <div className="mt-2 flex items-center gap-2 text-slate-500">
              ...
              <span className="text-base font-medium">
                Tu meta semanal es de <span className="text-slate-900 font-bold">{stats.metaSemanal} unidades</span>.
              </span>
            </div>
          </div>
              ...
              <div className="flex flex-col items-center">
                <div className="relative flex h-64 w-64 items-center justify-center">
                  ...
                  <div className="absolute flex flex-col items-center text-center">
                    ...
                    <span className="text-sm font-medium text-slate-500">de {stats.metaSemanal} Unidades</span>
                  </div>
                </div>
                <div className="mt-6 w-full space-y-3">
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className={`font-bold ${isOverLimit ? 'text-rose-500' : 'text-emerald-500'}`}>
